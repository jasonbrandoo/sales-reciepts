...
const Checkout = ({ location, navigate }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-100 sm:flex sm:flex-row">
      <Modal
        open={open}
        setOpen={setOpen}
        bill={state.totalPrice}
      ...
      <div className="sm:w-2/3 w-full bg-gray-500">
        <div className="m-8">
          ...
          {state.cart.map((item, index) => (
            <div key={item.title} className="flex flex-col">
              <div className="flex text-sm text-left break-words">
